...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>这里允许root用户远程的时候，如果出现如下的错误，就先去把root用的host改成%，再运行上面那句话，对于mysql用户管理这一块不熟悉的朋友们，请看我另一篇博客--mysql 用户及权限管理</p><p><img src="https://cdn.jsdelivr.net/gh/jiange1236/MyImage/MdImg/856176-20180428150157767-1407082633.png" alt="img"></p><p>非root用户，这里就要先去创建一个用户</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>切换数据库
mysql&gt;use mysql;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,32),t=[l];function d(r,c){return n(),e("div",null,t)}const v=s(i,[["render",d],["__file","MySQL.html.vue"]]);export{v as default};
