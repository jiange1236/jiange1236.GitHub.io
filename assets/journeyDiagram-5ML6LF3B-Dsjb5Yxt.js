...
`,`getStyles`),N=e(function(e,t){return m(e,t)},`drawRect`),P=e(function(t,n){let r=t.append(`circle`).attr(`cx`,n.cx).attr(`cy`,n.cy).attr(`class`,`face`).attr(`r`,15).attr(`stroke-width`,2).attr(`overflow`,`visible`),i=t.append(`g`);i.append(`circle`).attr(`cx`,n.cx-5).attr(`cy`,n.cy-5).attr(`r`,1.5).attr(`stroke-width`,2).attr(`fill`,`#666`).attr(`stroke`,`#666`),i.append(`circle`).attr(`cx`,n.cx+5).attr(`cy`,n.cy-5).attr(`r`,1.5).attr(`stroke-width`,2).attr(`fill`,`#666`).attr(`stroke`,`#666`);function a(e){let t=d().startAngle(Math.PI/2).endAngle(Math.PI/2*3).innerRadius(7.5).outerRadius(6.8181818181818175);e.append(`path`).attr(`class`,`mouth`).attr(`d`,t).attr(`transform`,`translate(`+n.cx+`,`+(n.cy+2)+`)`)}e(a,`smile`);function o(e){let t=d().startAngle(3*Math.PI/2).endAngle(Math.PI/2*5).innerRadius(7.5).outerRadius(6.8181818181818175);e.append(`path`).attr(`class`,`mouth`).attr(`d`,t).attr(`transform`,`translate(`+n.cx+`,`+(n.cy+7)+`)`)}e(o,`sad`);function s(e){e.append(`line`).attr(`class`,`mouth`).attr(`stroke`,2).attr(`x1`,n.cx-5).attr(`y1`,n.cy+7).attr(`x2`,n.cx+5).attr(`y2`,n.cy+7).attr(`class`,`mouth`).attr(`stroke-width`,`1px`).attr(`stroke`,`#666`)}return e(s,`ambivalent`),n.score>3?a(i):n.score<3?o(i):s(i),r},`drawFace`),F=e(function(e,t){let n=e.append(`circle`);return n.attr(`cx`,t.cx),n.attr(`cy`,t.cy),n.attr(`class`,`actor-`+t.pos),n.attr(`fill`,t.fill),n.attr(`stroke`,t.stroke),n.attr(`r`,t.r),n.class!==void 0&&n.attr(`class`,n.class),t.title!==void 0&&n.append(`title`).text(t.title),n},`drawCircle`),I=e(function(e,t){return h(e,t)},`drawText`),L=e(function(t,n){function r(e,t,n,r,i){return e+`,`+t+` `+(e+n)+`,`+t+` `+(e+n)+`,`+(t+r-i)+` `+(e+n-i*1.2)+`,`+(t+r)+` `+e+`,`+(t+r)}e(r,`genPoints`);let i=t.append(`polygon`);i.attr(`points`,r(n.x,n.y,50,20,7)),i.attr(`class`,`labelBox`),n.y+=n.labelMargin,n.x+=.5*n.labelMargin,I(t,n)},`drawLabel`),R=e(function(e,t,n){let r=e.append(`g`),i=f();i.x=t.x,i.y=t.y,i.fill=t.fill,i.width=n.width*t.taskCount+n.diagramMarginX*(t.taskCount-1),i.height=n.height,i.class=`journey-section section-type-`+t.num,i.rx=3,i.ry=3,N(r,i),H(n)(t.text,r,i.x,i.y,i.width,i.height,{class:`journey-section section-type-`+t.num},n,t.colour)},`drawSection`),z=-1,B=e(function(e,t,n){let r=t.x+n.width/2,i=e.append(`g`);z++,i.append(`line`).attr(`id`,`task`+z).attr(`x1`,r).attr(`y1`,t.y).attr(`x2`,r).attr(`y2`,450).attr(`class`,`task-line`).attr(`stroke-width`,`1px`).attr(`stroke-dasharray`,`4 2`).attr(`stroke`,`#666`),P(i,{cx:r,cy:300+(5-t.score)*30,score:t.score});let a=f();a.x=t.x,a.y=t.y,a.fill=t.fill,a.width=n.width,a.height=n.height,a.class=`task task-type-`+t.num,a.rx=3,a.ry=3,N(i,a);let o=t.x+14;t.people.forEach(e=>{let n=t.actors[e].color,r={cx:o,cy:t.y,r:7,fill:n,stroke:`#000`,title:e,pos:t.actors[e].position};F(i,r),o+=10}),H(n)(t.task,i,a.x,a.y,a.width,a.height,{class:`task`},n,t.colour)},`drawTask`),V=e(function(e,t){p(e,t)},`drawBackgroundRect`),H=function(){function t(e,t,n,r,a,o,s,c){i(t.append(`text`).attr(`x`,n+a/2).attr(`y`,r+o/2+5).style(`font-color`,c).style(`text-anchor`,`middle`).text(e),s)}e(t,`byText`);function n(e,t,n,r,a,o,s,c,l){let{taskFontSize:u,taskFontFamily:d}=c,f=e.split(/<br\s*\/?>/gi);for(let e=0;e<f.length;e++){let c=e*u-u*(f.length-1)/2,p=t.append(`text`).attr(`x`,n+a/2).attr(`y`,r).attr(`fill`,l).style(`text-anchor`,`middle`).style(`font-size`,u).style(`font-family`,d);p.append(`tspan`).attr(`x`,n+a/2).attr(`dy`,c).text(f[e]),p.attr(`y`,r+o/2).attr(`dominant-baseline`,`central`).attr(`alignment-baseline`,`central`),i(p,s)}}e(n,`byTspan`);function r(e,t,r,a,o,s,c,l){let u=t.append(`switch`),d=u.append(`foreignObject`).attr(`x`,r).attr(`y`,a).attr(`width`,o).attr(`height`,s).attr(`position`,`fixed`).append(`xhtml:div`).style(`display`,`table`).style(`height`,`100%`).style(`width`,`100%`);d.append(`div`).attr(`class`,`label`).style(`display`,`table-cell`).style(`text-align`,`center`).style(`vertical-align`,`middle`).text(e),n(e,u,r,a,o,s,c,l),i(d,c)}e(r,`byFo`);function i(e,t){for(let n in t)n in t&&e.attr(n,t[n])}return e(i,`_setTextAttrs`),function(e){return e.textPlacement===`fo`?r:e.textPlacement===`old`?t:n}}(),U={drawRect:N,drawCircle:F,drawSection:R,drawText:I,drawLabel:L,drawTask:B,drawBackgroundRect:V,initGraphics:e(function(e){e.append(`defs`).append(`marker`).attr(`id`,`arrowhead`).attr(`refX`,5).attr(`refY`,2).attr(`markerWidth`,6).attr(`markerHeight`,4).attr(`orient`,`auto`).append(`path`).attr(`d`,`M 0,0 V 4 L6,2 Z`)},`initGraphics`)},W=e(function(e){Object.keys(e).forEach(function(t){q[t]=e[t]})},`setConf`),G={};function K(e){let t=n().journey,r=60;Object.keys(G).forEach(n=>{let i=G[n].color,a={cx:20,cy:r,r:7,fill:i,stroke:`#000`,pos:G[n].position};U.drawCircle(e,a);let o={x:40,y:r+7,fill:`#666`,text:n,textMargin:t.boxTextMargin|5};U.drawText(e,o),r+=20})}e(K,`drawActorLegend`);var q=n().journey,J=q.leftMargin,Y=e(function(e,r,i,a){let o=n().journey,c=n().securityLevel,l;c===`sandbox`&&(l=s(`#i`+r));let u=s(c===`sandbox`?l.nodes()[0].contentDocument.body:`body`);X.init();let d=u.select(`#`+r);U.initGraphics(d);let f=a.db.getTasks(),p=a.db.getDiagramTitle(),m=a.db.getActors();for(let e in G)delete G[e];let h=0;m.forEach(e=>{G[e]={color:o.actorColours[h%o.actorColours.length],position:h},h++}),K(d),X.insert(0,0,J,Object.keys(G).length*50),ee(d,f,0);let g=X.getBounds();p&&d.append(`text`).text(p).attr(`x`,J).attr(`font-size`,`4ex`).attr(`font-weight`,`bold`).attr(`y`,25);let _=g.stopy-g.starty+2*o.diagramMarginY,v=J+g.stopx+2*o.diagramMarginX;t(d,_,v,o.useMaxWidth),d.append(`line`).attr(`x1`,J).attr(`y1`,o.height*4).attr(`x2`,v-J-4).attr(`y2`,o.height*4).attr(`stroke-width`,4).attr(`stroke`,`black`).attr(`marker-end`,`url(#arrowhead)`);let y=p?70:0;d.attr(`viewBox`,`${g.startx} -25 ${v} ${_+y}`),d.attr(`preserveAspectRatio`,`xMinYMin meet`),d.attr(`height`,_+y+25)},`draw`),X={data:{startx:void 0,stopx:void 0,starty:void 0,stopy:void 0},verticalPos:0,sequenceItems:[],init:e(function(){this.sequenceItems=[],this.data={startx:void 0,stopx:void 0,starty:void 0,stopy:void 0},this.verticalPos=0},`init`),updateVal:e(function(e,t,n,r){e[t]=e[t]===void 0?n:r(n,e[t])},`updateVal`),updateBounds:e(function(t,r,i,a){let o=n().journey,s=this,c=0;function l(n){return e(function(e){c++;let l=s.sequenceItems.length-c+1;s.updateVal(e,`starty`,r-l*o.boxMargin,Math.min),s.updateVal(e,`stopy`,a+l*o.boxMargin,Math.max),s.updateVal(X.data,`startx`,t-l*o.boxMargin,Math.min),s.updateVal(X.data,`stopx`,i+l*o.boxMargin,Math.max),n!==`activation`&&(s.updateVal(e,`startx`,t-l*o.boxMargin,Math.min),s.updateVal(e,`stopx`,i+l*o.boxMargin,Math.max),s.updateVal(X.data,`starty`,r-l*o.boxMargin,Math.min),s.updateVal(X.data,`stopy`,a+l*o.boxMargin,Math.max))},`updateItemBounds`)}e(l,`updateFn`),this.sequenceItems.forEach(l())},`updateBounds`),insert:e(function(e,t,n,r){let i=Math.min(e,n),a=Math.max(e,n),o=Math.min(t,r),s=Math.max(t,r);this.updateVal(X.data,`startx`,i,Math.min),this.updateVal(X.data,`starty`,o,Math.min),this.updateVal(X.data,`stopx`,a,Math.max),this.updateVal(X.data,`stopy`,s,Math.max),this.updateBounds(i,o,a,s)},`insert`),bumpVerticalPos:e(function(e){this.verticalPos+=e,this.data.stopy=this.verticalPos},`bumpVerticalPos`),getVerticalPos:e(function(){return this.verticalPos},`getVerticalPos`),getBounds:e(function(){return this.data},`getBounds`)},Z=q.sectionFills,Q=q.sectionColours,ee=e(function(e,t,r){let i=n().journey,a=``,o=r+(i.height*2+i.diagramMarginY),s=0,c=`#CCC`,l=`black`,u=0;for(let[n,r]of t.entries()){if(a!==r.section){c=Z[s%Z.length],u=s%Z.length,l=Q[s%Q.length];let o=0,d=r.section;for(let e=n;e<t.length&&t[e].section==d;e++)o+=1;let f={x:n*i.taskMargin+n*i.width+J,y:50,text:r.section,fill:c,num:u,colour:l,taskCount:o};U.drawSection(e,f,i),a=r.section,s++}let d=r.people.reduce((e,t)=>(G[t]&&(e[t]=G[t]),e),{});r.x=n*i.taskMargin+n*i.width+J,r.y=o,r.width=i.diagramMarginX,r.height=i.diagramMarginY,r.colour=l,r.fill=c,r.num=u,r.actors=d,U.drawTask(e,r,i),X.insert(r.x,r.y,r.x+r.width+i.taskMargin,450)}},`drawTasks`),$={setConf:W,draw:Y},te={parser:_,db:j,renderer:$,styles:M,init:e(e=>{$.setConf(e.journey),j.clear()},`init`)};export{te as diagram};