...
![img](./attachments/Cameyo.assets/181413.png)
...
软件便携化制作方法：打开扫描生成的包
![img](./attachments/Cameyo.assets/181541.png)
设置磁盘模式（如果文件小于10M可以设置内存模式，否则启动慢），隔离选择完全访问
![img](./attachments/Cameyo.assets/181543.png)
数据存储设置为可执行文件目录下
![img](./attachments/Cameyo.assets/181545.png)
打开高级设置，选择不保留任何注册表（程序不会写入系统注册表，而是重定向到数据目录）
![img](./attachments/Cameyo.assets/181547.png)
