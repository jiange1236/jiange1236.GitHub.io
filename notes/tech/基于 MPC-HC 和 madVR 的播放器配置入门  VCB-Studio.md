...
本教程基于 [K-Lite Codec Pack Full](https://codecguide.com/download_k-lite_codec_pack_full.htm) ，其中已经包含了 MPC-HC 和 madVR。MPC-HC 现在已由 clsid2（原 MPC [6.4.9.1](http://6.4.9.1/) 开发者）接手继续开发，而 madVR 应该已经不需要再多做介绍。
...
![](./attachments/基于%20MPC-HC%20和%20madVR%20的播放器配置入门%20%20VCB-Studio.assets/k-lite_setup_1.png)

（当然，如果你不用 madVR，这里保留默认的“MPC Video Renderer”就好）

– 为了保证播放稳定可靠，我们一般建议只使用软件解码（见后文补充说明）

![](./attachments/基于%20MPC-HC%20和%20madVR%20的播放器配置入门%20%20VCB-Studio.assets/k-lite_setup_2.png)
...
![](./attachments/基于%20MPC-HC%20和%20madVR%20的播放器配置入门%20%20VCB-Studio.assets/madvr_setup_1.png)
...
![](./attachments/基于%20MPC-HC%20和%20madVR%20的播放器配置入门%20%20VCB-Studio.assets/madvr_setup_2.1.png)
...
![](./attachments/基于%20MPC-HC%20和%20madVR%20的播放器配置入门%20%20VCB-Studio.assets/madvr_setup_3.png)
...
![](./attachments/基于%20MPC-HC%20和%20madVR%20的播放器配置入门%20%20VCB-Studio.assets/madvr_setup_4.1.1.png) ![](./attachments/基于%20MPC-HC%20和%20madVR%20的播放器配置入门%20%20VCB-Studio.assets/madvr_setup_4.2.png) ![](./attachments/基于%20MPC-HC%20和%20madVR%20的播放器配置入门%20%20VCB-Studio.assets/madvr_setup_4.3.png)
...
![](./attachments/基于%20MPC-HC%20和%20madVR%20的播放器配置入门%20%20VCB-Studio.assets/madvr_info_abyss.webp)
...
![](./attachments/基于%20MPC-HC%20和%20madVR%20的播放器配置入门%20%20VCB-Studio.assets/xysubfilter_libass.png)
...
![](./attachments/基于%20MPC-HC%20和%20madVR%20的播放器配置入门%20%20VCB-Studio.assets/lav_hwdec_d3d11.png)
...
![](./attachments/基于%20MPC-HC%20和%20madVR%20的播放器配置入门%20%20VCB-Studio.assets/create_3dlut.png)

点击右下角按钮，选择保存位置，完成后，把得到的.3dlut 文件放在一个合适的位置，然后打开 madVR 设置，按下图设置，确保“disable GPU gamma ramps”不勾选：

![](./attachments/基于%20MPC-HC%20和%20madVR%20的播放器配置入门%20%20VCB-Studio.assets/madvr_3dlut.png)
