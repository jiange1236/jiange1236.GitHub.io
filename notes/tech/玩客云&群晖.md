...
```
curl -L --output cloudflared.deb https://github.com/cloudflare/cloudflared/releases/download/2024.11.1/cloudflared-linux-armhf.deb

sudo dpkg -i cloudflared.deb

sudo cloudflared service install eyJhIjoiZjAxNzExNGYyYTQ0YzI4NmVmZjNkZmVkMTIyNWIzZmUiLCJ0IjoiNWU3MjI4ZGEtYzNkZS00NDA4LTgwMWYtYWMyZTI4MWE3OWZhIiwicyI6IlpHUTRPV1JoT0RVdFpqUTBNUzAwT0dSaExUaGlaREF0WkRneU16RTRaREEzTkROayJ9
```

docker版

```
docker run --name cloudflared -d --restart=unless-stopped --net=host zoeyvid/cloudflared:latest tunnel --no-autoupdate run --token eyJhIjoiZjAxNzExNGYyYTQ0YzI4NmVmZjNkZmVkMTIyNWIzZmUiLCJ0IjoiNWU3MjI4ZGEtYzNkZS00NDA4LTgwMWYtYWMyZTI4MWE3OWZhIiwicyI6IlpHUTRPV1JoT0RVdFpqUTBNUzAwT0dSaExUaGlaREF0WkRneU16RTRaREEzTkROayJ9 
