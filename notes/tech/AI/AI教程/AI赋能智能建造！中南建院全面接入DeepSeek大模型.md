...
中南建院此前已在GiantAI平台接入DeepSeek-R1模型，凭借其低成本推理与端侧部署优势，\*\*已在设计环节实现“人机共创”常态化。\*\*设计师输入关键词后，**系统可秒级生成10余种风格迥异的效果图方案，并通过动态调整材质、光影与空间比例优化设计成果。这一技术突破不仅缩短了方案迭代周期，还有效降低了初期设计成本。**
